        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(item, index) in spuSaleAttrList" :key="item.id">
                ...
                <dd
                  ...
                  :key="item2.id"
                  @click="changeIsChecked(item.spuSaleAttrValueList,item2)"
                >
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a href="javascript:" @click="getShopCart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    // 加入购物车的回调函数
    async getShopCart(skuId,skuNum){
      try {
         let result=  await this.$store.dispatch("detail/getShopCart",{skuId:this.$route.params.skuid,skuNum:this.skuNum})
