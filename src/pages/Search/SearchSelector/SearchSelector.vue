  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="item in trademarkList" :key="item.tmId" @click="markHandler(item)">{{item.tmName}}</li>
        </ul>
      </div>
      <div class="ext">
    ...
    <div class="type-wrap" v-for="item in attrsList" :key="item.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
        <!-- 点击选择属性 -->
          <li v-for="item2 in item.attrValueList" :key="item2.attrId" @click="attrInfo(item,item2)">{{item2}}</li>
